...
<div class="wrapper">
    <h1>商品情報詳細画面</h1>
    <div class="containts">
        <form action="{{ route('products.edit', ['id' => $product->id]) }}" method="GET" enctype="multipart/form-data">
            @csrf
            <div class="product-details">
                ...
                <div class="detail-row">
                    ...
                    <input type="text" name="productName" id="productName" value="{{ $product->product_name }}" readonly>
                </div>
                <div class="detail-row">
                ...
                <div class="detail-row">
                    ...
                    <textarea type="text" name="description" id="description" readonly>{{ $product->description }}</textarea>
                </div>
                <div class="detail-row">
