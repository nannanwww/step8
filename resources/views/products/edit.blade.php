            ...
            <div class="product-details">
                ...
                <div class="detail-row">
                    ...
                    <div class="image-input-container">
                        @if ($product->image)
                            <img src="{{ asset('storage/images/' . basename($product->image)) }}" alt="商品画像" class="product_image">
                        @else
                            <div class="spacer">
                                No image
                            </div>
                        @endif
                        <input type="file" name="image" id="image" accept="image/*" value="{{$product->image}}" class="input-file">
                    </div>
                </div>
